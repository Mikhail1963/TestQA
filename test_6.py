...
assert value_product_1 == value_cart_product_1  # Сравнение названия товара в каталоге и в корзине.
...
assert value_price_product_1 == value_price_cart_product_1  # Сравнение цены товара в каталоге и в корзине.
...
assert value_product_1 == value_finish_product_1  # Сравнение названия товара в каталоге и в заказе.
...
assert value_price_product_1 == value_price_finish_product_1  # Сравнение цены товара в каталоге и в заказе.
...
print(item_total)
assert value_summary_price == item_total  # Сравнение строки "Финальная стоимость товара".
